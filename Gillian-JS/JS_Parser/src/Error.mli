type t =
  ...
  | Unhandled_Expression of Loc.t
      (** The expression at the given a location is not handled. Maybe because
          it is not part of ES5. *)
  ...
  | LoaderError of string * int * string * string
      (** Some error happened when trying to process CommonJS constructs such as
          [require]. *)
