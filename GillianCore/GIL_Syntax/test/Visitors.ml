...
let test_lit_base_elements () =
  ...
  Alcotest.check list_literal "Get base elements in recursive list"
      ...
      [
        ...
        EList
          [
            ...
            BinOp (UnOp (UNot, Lit (Num 32.)), Plus, PVar "b");
          ];
        LVar "a";
        ALoc "e";
      ]
