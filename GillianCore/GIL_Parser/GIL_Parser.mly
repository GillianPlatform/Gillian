...
%token FUNSIGNEDRIGHTSHIFTL
%token IUNSIGNEDRIGHTSHIFTL
%token M_ATAN2
%token M_POW
%token LSTCAT
%token LSTREV
...
%left LEFTSHIFT SIGNEDRIGHTSHIFT UNSIGNEDRIGHTSHIFT LEFTSHIFTL SIGNEDRIGHTSHIFTL FUNSIGNEDRIGHTSHIFTL IUNSIGNEDRIGHTSHIFTL
...
binop_target:
  ...
  | FUNSIGNEDRIGHTSHIFTL { BinOp.FUnsignedRightShiftL }
  | IUNSIGNEDRIGHTSHIFTL { BinOp.IUnsignedRightShiftL }
