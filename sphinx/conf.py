...
# -*- coding: utf-8 -*-
#
# Gillian documentation build configuration file, created by
# sphinx-quickstart.
#
...
# ones.
extensions = ['gillian_custom_roles']
...
author = 'Gillian Team @ Imperial College London'
...
latex_documents = [
    (master_doc, 'Gillian.tex', 'Gillian Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'Gillian', 'Gillian Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Gillian', 'Gillian Documentation',
     author, 'Gillian', 'One line description of project.',
     'Miscellaneous'),
]
